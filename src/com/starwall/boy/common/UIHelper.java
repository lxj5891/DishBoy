package com.starwall.boy.common;
...
import com.starwall.boy.app.ActionActivity;
...
public class UIHelper {
     ...
     * @param context
     */
    public static void showDeskAction(Context context) {

        Intent intent = new Intent();

        intent.setClass(context, ActionActivity.class);

        DeskActivity deskActivity = (DeskActivity) context;
        deskActivity.startActivity(intent);
        deskActivity.overridePendingTransition(R.anim.in_from_down,R.anim.out_to_up);
    }
